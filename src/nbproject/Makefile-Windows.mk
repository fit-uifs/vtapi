...
LDLIBSOPTIONS=-lopencv_core -lopencv_imgproc -lopencv_highgui -lopencv_ml -lopencv_video -lopencv_features2d -lopencv_calib3d -lopencv_objdetect -lopencv_contrib -lopencv_legacy -lopencv_flann -lpq -lpqtypes -lgeos -lgeos_c -lws2_32 ../dist/liblwgeom.so

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Windows.mk ../dist/libvtapi.so

../dist/libvtapi.so: ../dist/liblwgeom.so

../dist/libvtapi.so: ${OBJECTFILES}
	${MKDIR} -p ../dist
	${LINK.cc} -shared -o ../${CND_DISTDIR}/libvtapi.so ${OBJECTFILES} ${LDLIBSOPTIONS} 
