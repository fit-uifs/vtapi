...
SELECT public.VT_method_add('demo1', '{"(features_array,real[],out,,true,,)", "(features_mat,public.cvmat,out,,,,)"}', '{"(param1,int,true,50,[-100\\,100],)", "(param2,double,true,0.5,[-1.0\\,1.0],)"}', 'auto-generated');

-- insert demo2 modules metadata into public schema
SELECT public.VT_method_delete('demo2');
SELECT public.VT_method_add('demo2', '{"(features_array,real[],in,,,,)", "(features_mat,public.cvmat,in,,,,)", "(event,public.vtevent,out,true,,{4},)"}', '{"(video,string,true,,,)"}', 'auto-generated');
